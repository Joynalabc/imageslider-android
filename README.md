<!--lint disable-->
<a href="https://github.com/Joynalabc/imageslider-android">  
...
[![](https://jitpack.io/v/Joynalabc/imageslider-android.svg)](https://jitpack.io/#Joynalabc/imageslider-android)
...
```xml  
  <com.entersoftbd.imageslider_android.ImageSlider
...
```kt  
import  com.entersoftbd.imageslider_android.constants.ScaleTypes // important  
...
```  
-   You can add animation like that, <b>14 Animations added</b>. You can check in <a href="https://github.com/Joynalabc/imageslider-android/tree/master/imageslider-android/src/main/java/com/entersoftbd/imageslider_android/animations"> Animation List </a>
```kt  
...
dependencies {
 implementation 'com.github.Joynalabc:imageslider-android:1.0'
}
```  
